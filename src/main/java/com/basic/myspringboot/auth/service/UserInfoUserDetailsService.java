...
public class UserInfoUserDetailsService implements UserDetailsService {
    ...
    public String addUser(UserInfo userInfo) {
        ...
        //UserInfo 클래스의 username, password를 DB에 저장
